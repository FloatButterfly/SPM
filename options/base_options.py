...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='spm', help='which model to use')
        ...
        parser.add_argument('--k_latent', type=float, default=10.0, help='weight for latent regression loss')
        ...
        parser.add_argument('--k_L1', type=float, default=1.0, help='weight for latent regression loss')
        ...
        parser.add_argument('--binary_quant', action='store_true', help='use binary quantization, qp_step=-{1,2,3,4,5,6,7,8}')
        parser.add_argument('--qp_step', type=float, default=-8,
                            help='quantization scale for style_matrix: -{1,2,3,4,5,6,7,8}')
